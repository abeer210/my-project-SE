...
public final class ConnectionPool {
    ...
    private static final Executor executor = new ThreadPoolExecutor(0, (int) C0188.f24, 60, TimeUnit.SECONDS, new SynchronousQueue(), Util.threadFactory(C0201.m82(19755), true));
    ...
    private int pruneAndGetAllocationCount(RealConnection realConnection, long j) {
        ...
        while (i < list.size()) {
            ...
            if (reference.get() != null) {
                ...
                Platform.get().logCloseableLeak(C0201.m82(19757) + realConnection.route().address().url() + C0201.m82(19758), ((StreamAllocation.StreamAllocationReference) reference).callStackTrace);
                list.remove(i);
    ...
    public ConnectionPool(int i, long j, TimeUnit timeUnit) {
        ...
        if (j <= 0) {
            throw new IllegalArgumentException(C0201.m82(19756) + j);
        }
    }
}
