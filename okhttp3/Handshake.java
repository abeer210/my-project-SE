...
public final class Handshake {
    ...
    public static Handshake get(SSLSession sSLSession) throws IOException {
        ...
        if (cipherSuite2 == null) {
            throw new IllegalStateException(C0201.m82(19886));
        } else if (!C0201.m82(19881).equals(cipherSuite2)) {
            CipherSuite forJavaName = CipherSuite.forJavaName(cipherSuite2);
            String protocol = sSLSession.getProtocol();
            if (protocol == null) {
                throw new IllegalStateException(C0201.m82(19884));
            } else if (!C0201.m82(19882).equals(protocol)) {
                ...
                throw new IOException(C0201.m82(19883));
            }
        } else {
            throw new IOException(C0201.m82(19885));
        }
    }
