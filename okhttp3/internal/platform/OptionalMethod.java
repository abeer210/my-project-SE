...
public class OptionalMethod<T> {
    ...
    public Object invoke(T t, Object... objArr) throws InvocationTargetException {
        ...
        if (method != null) {
            try {
                ...
                AssertionError assertionError = new AssertionError(C0201.m82(25194) + method);
                assertionError.initCause(e);
                throw assertionError;
            }
        } else {
            throw new AssertionError(C0201.m82(25195) + this.methodName + C0201.m82(25196) + ((Object) t));
        }
    }
    ...
    public Object invokeOptionalWithoutCheckedException(T t, Object... objArr) {
        try {
            ...
            AssertionError assertionError = new AssertionError(C0201.m82(25197));
    ...
    public Object invokeWithoutCheckedException(T t, Object... objArr) {
        try {
            ...
            AssertionError assertionError = new AssertionError(C0201.m82(25198));
            assertionError.initCause(targetException);
            throw assertionError;
        }
    }
