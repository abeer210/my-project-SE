...
public class Huffman {
    ...
    private void addCode(int i, int i2, byte b) {
        ...
        while (b > 8) {
            ...
            if (nodeArr != null) {
                ...
                throw new IllegalStateException(C0201.m82(4669));
            }
        }
        int i4 = 8 - b;
        int i5 = (i2 << i4) & 255;
    ...
    public void encode(dy2 dy2, by2 by2) throws IOException {
        int i = 0;
        long j = 0;
        byte b = 0;
        while (i < dy2.A()) {
        ...
        if (b > 0) {
            by2.O((int) (((long) (255 >>> b)) | (j << (8 - b))));
        }
    }

    public int encodedLength(dy2 dy2) {
        long j = 0;
        for (int i = 0; i < dy2.A(); i++) {
            j += (long) CODE_LENGTHS[dy2.l(i) & 255];
        }
        return (int) ((j + 7) >> 3);
    }
