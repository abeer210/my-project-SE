...
public final class RouteSelector {
    ...
    private Proxy nextProxy() throws IOException {
        ...
        throw new SocketException(C0201.m82(37387) + this.address.url().host() + C0201.m82(37388) + this.proxies);
    }
    ...
    private void resetNextInetSocketAddress(Proxy proxy) throws IOException {
        ...
        if (proxy.type() == Proxy.Type.DIRECT || proxy.type() == Proxy.Type.SOCKS) {
            ...
            if (address2 instanceof InetSocketAddress) {
                ...
                throw new IllegalArgumentException(C0201.m82(37389) + address2.getClass());
            }
        }
        if (i < 1 || i > 65535) {
            throw new SocketException(C0201.m82(37391) + str + C0201.m82(37392) + i + C0201.m82(37393));
            ...
            throw new UnknownHostException(this.address.dns() + C0201.m82(37390) + str);
        }
    }
