...
public final class CallServerInterceptor implements Interceptor {
    ...
    static final class CountingSink extends ey2 {
        public long successfulCount;

        public CountingSink(sy2 sy2) {
            super(sy2);
        }
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (HttpMethod.permitsRequestBody(request.method()) && request.body() != null) {
            if (C0201.m82(32229).equalsIgnoreCase(request.header(C0201.m82(32228)))) {
        ...
        String r2 = C0201.m82(32230);
        String header = request2.header(r2);
        String r3 = C0201.m82(32231);
        if (r3.equalsIgnoreCase(header) || r3.equalsIgnoreCase(response.header(r2))) {
            streamAllocation.noNewStreams();
        }
        if ((code != 204 && code != 205) || response.body().contentLength() <= 0) {
            return response;
        }
        throw new ProtocolException(C0201.m82(32232) + code + C0201.m82(32233) + response.body().contentLength());
    }
}
