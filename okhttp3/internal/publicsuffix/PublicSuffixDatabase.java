...
public final class PublicSuffixDatabase {
    ...
    private static final byte EXCEPTION_MARKER = 0;
    private static final String[] PREVAILING_RULE = {C0201.m82(5459)};
    ...
    static {
        C0201.m83(PublicSuffixDatabase.class, 506);
    }
    ...
    private String[] findMatchingRule(String[] strArr) {
        ...
        synchronized (this) {
            if (this.publicSuffixListBytes == null) {
                throw new IllegalStateException(C0201.m82(5464));
            }
        }
        ...
        if (str != null) {
            return (C0201.m82(5460) + str).split(C0201.m82(5461));
        } else if (str2 == null && str3 == null) {
            return PREVAILING_RULE;
        } else {
            if (str2 != null) {
                strArr2 = str2.split(C0201.m82(5462));
            } else {
                strArr2 = EMPTY_RULE;
            }
            if (str3 != null) {
                strArr3 = str3.split(C0201.m82(5463));
            } else {
                strArr3 = EMPTY_RULE;
            }
    ...
    private void readTheList() throws IOException {
        InputStream resourceAsStream = PublicSuffixDatabase.class.getResourceAsStream(C0201.m82(5465));
        if (resourceAsStream != null) {
            cy2 d = jy2.d(new hy2(jy2.k(resourceAsStream)));
            try {
    ...
    private void readTheListUninterruptibly() {
        ...
        while (true) {
            try {
                ...
                Platform.get().log(5, C0201.m82(5466), e);
                if (z) {
                    Thread.currentThread().interrupt();
                    return;
                }
    ...
    public String getEffectiveTldPlusOne(String str) {
        ...
        if (str != null) {
            ...
            String r1 = C0201.m82(5467);
            String[] split = unicode.split(r1);
        ...
        throw new NullPointerException(C0201.m82(5468));
    }
