...
public final class JavaNetAuthenticator implements Authenticator {
    ...
    public Request authenticate(Route route, Response response) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (C0201.m82(15043).equalsIgnoreCase(challenge.scheme())) {
                if (z) {
                ...
                if (passwordAuthentication != null) {
                    return request.newBuilder().header(z ? C0201.m82(15044) : C0201.m82(15045), Credentials.basic(passwordAuthentication.getUserName(), new String(passwordAuthentication.getPassword()), challenge.charset())).build();
                }
            }
        }
        return null;
