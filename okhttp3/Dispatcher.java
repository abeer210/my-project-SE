...
public final class Dispatcher {
    ...
    public synchronized ExecutorService executorService() {
        if (this.executorService == null) {
            this.executorService = new ThreadPoolExecutor(0, (int) C0188.f24, 60, TimeUnit.SECONDS, new SynchronousQueue(), Util.threadFactory(C0201.m82(4336), false));
        }
    ...
    public void setMaxRequests(int i) {
        ...
        throw new IllegalArgumentException(C0201.m82(4337) + i);
    }
    ...
    public void setMaxRequestsPerHost(int i) {
        ...
        throw new IllegalArgumentException(C0201.m82(4338) + i);
    }
    ...
    private <T> void finished(Deque<T> deque, T t) {
        ...
        synchronized (this) {
            if (deque.remove(t)) {
                ...
                throw new AssertionError(C0201.m82(4335));
            }
        }
