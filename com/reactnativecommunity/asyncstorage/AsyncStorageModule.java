...
@pj0(name = "RNC_AsyncSQLiteDBStorage")
public final class AsyncStorageModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
    ...
    class a extends GuardedAsyncTask<Void, Void> {
        ...
        public void doInBackgroundGuarded(Void... voidArr) {
            ...
            for (int i = 0; i < this.b.size(); i += 999) {
                ...
                Cursor query = AsyncStorageModule.this.mReactDatabaseSupplier.n().query(e, strArr, a.a(min), a.b(this.b, i, min), null, null, null);
                hashSet.clear();
                try {
    ...
    class b extends GuardedAsyncTask<Void, Void> {
        ...
        /* renamed from: a */
        public void doInBackgroundGuarded(Void... voidArr) {
            String r9 = C0201.m82(4937);
            WritableMap writableMap = null;
            if (!AsyncStorageModule.this.ensureDatabase()) {
                this.a.invoke(b.a(null));
                return;
            }
            SQLiteStatement compileStatement = AsyncStorageModule.this.mReactDatabaseSupplier.n().compileStatement(C0201.m82(4938));
            try {
    ...
    class c extends GuardedAsyncTask<Void, Void> {
        ...
        public void doInBackgroundGuarded(Void... voidArr) {
            ...
            try {
                ...
                for (int i = 0; i < this.b.size(); i += 999) {
                    int min = Math.min(this.b.size() - i, 999);
                    AsyncStorageModule.this.mReactDatabaseSupplier.n().delete(C0201.m82(6146), a.a(min), a.b(this.b, i, min));
                }
                AsyncStorageModule.this.mReactDatabaseSupplier.n().setTransactionSuccessful();
                try {
                    AsyncStorageModule.this.mReactDatabaseSupplier.n().endTransaction();
    ...
    class e extends GuardedAsyncTask<Void, Void> {
        ...
        public void doInBackgroundGuarded(Void... voidArr) {
            ...
            try {
                ...
                f60.B(C0201.m82(5955), e.getMessage(), e);
    ...
    class f extends GuardedAsyncTask<Void, Void> {
        ...
        public void doInBackgroundGuarded(Void... voidArr) {
            ...
            WritableArray createArray = Arguments.createArray();
            Cursor query = AsyncStorageModule.this.mReactDatabaseSupplier.n().query(d, new String[]{c}, null, null, null, null, null);
            try {
                if (query.moveToFirst()) {
                    do {
    ...
    static {
        C0201.m83(AsyncStorageModule.class, 703);
    }
    ...
    public AsyncStorageModule(ReactApplicationContext reactApplicationContext, Executor executor2) {
        ...
        this.mReactDatabaseSupplier = e.o(reactApplicationContext);
    }
}
