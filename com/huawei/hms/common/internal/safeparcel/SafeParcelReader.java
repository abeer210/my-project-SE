...
public class SafeParcelReader {
    private static final int BIT16_MARK = 0;
    private static final int FIELD_ID_CHECKER = 0;
    private static final int MAX_ARRAY_LENGTH = 0;
    private static final int NEGATIVE_MARK = 0;
    private static final int OFFSET16 = 0;
    ...
    public static class ParseException extends RuntimeException {
        ...
        public ParseException(String str, Parcel parcel) {
            ...
            stringBuffer.append(C0201.m82(13860));
            stringBuffer.append(parcel.dataPosition());
            stringBuffer.append(C0201.m82(13861));
            stringBuffer.append(parcel.dataSize());
        }
    }

    static {
        C0201.m83(SafeParcelReader.class, 391);
    }
    ...
    private static void sizeChecker(Parcel parcel, int i, int i2) {
        ...
        if (readSize != i2) {
            ...
            sb.append(C0201.m82(18448));
            sb.append(i2);
            sb.append(C0201.m82(18449));
            sb.append(readSize);
            sb.append(C0201.m82(18450));
            sb.append(hexString);
            sb.append(C0201.m82(18451));
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        if (getFieldId(readHeader) != 20293) {
            String r1 = C0201.m82(18456);
            String hexString = Integer.toHexString(readHeader);
            if (hexString.length() != 0) {
                r1 = r1.concat(hexString);
            }
            throw new ParseException(r1, parcel);
        }
        int i = readSize + dataPosition;
        if (i >= dataPosition && i <= parcel.dataSize()) {
            return i;
        }
        throw new ParseException(C0201.m82(18457) + dataPosition + C0201.m82(18458) + i, parcel);
    }
    ...
    private static void sizeChecker(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            ...
            StringBuilder sb = new StringBuilder(hexString.length() + 46);
            sb.append(C0201.m82(18452));
            sb.append(i3);
            sb.append(C0201.m82(18453));
            sb.append(i2);
            sb.append(C0201.m82(18454));
            sb.append(hexString);
            sb.append(C0201.m82(18455));
            throw new ParseException(sb.toString(), parcel);
        }
    }
}
