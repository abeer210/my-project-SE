...
public class Feature extends AbstractSafeParcelable {
    public static final int ARGS_NAME = 0;
    public static final int ARGS_SVC_VER = 0;
    public static final int ARGS_VER = 0;
    public static final Parcelable.Creator<Feature> CREATOR = new FeatureCreator();
    private static final int SVC_VER = 0;
    ...
    public String toString() {
        return Objects.toStringHelper(this).add(C0201.m82(38923), getName()).add(C0201.m82(38924), Long.valueOf(getVersion())).toString();
    }
