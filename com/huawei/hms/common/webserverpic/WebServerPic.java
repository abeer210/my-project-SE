...
public class WebServerPic {
    ...
    public WebServerPic(Uri uri, int i, int i2) throws IllegalArgumentException {
        ...
        this.height = i2;
        if (uri == null) {
            throw new IllegalArgumentException(C0201.m82(1196));
        } else if (i < 0 || i2 < 0) {
            throw new IllegalArgumentException(C0201.m82(1195));
        }
    }
    ...
    public final String toString() {
        return String.format(Locale.ENGLISH, C0201.m82(1197), Integer.valueOf(this.width), Integer.valueOf(this.height), this.url.toString());
    }
