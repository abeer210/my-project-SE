...
/* compiled from: GetLastLocationEnhanceTaskApiCall */
public class d extends b<o, HWLocation> {
    ...
    /* renamed from: a */
    public void doExecute(o oVar, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource<HWLocation> taskCompletionSource) {
        String r0;
        String r1;
        int i;
        int i2;
        ...
        try {
            ...
            if (responseErrorCode != null) {
                ...
                try {
                    ...
                    com.huawei.hms.support.api.a.c.a.b.a().a(taskCompletionSource, responseErrorCode, hWLocation);
                    ...
                    i = e.getStatusCode();
                    String str2 = this.a;
                    b.d(r0, str2, C0201.m82(4878) + e.getMessage());
            ...
            i = e.getStatusCode();
            String str22 = this.a;
            b.d(r0, str22, C0201.m82(4878) + e.getMessage());
            taskCompletionSource.setException(e);
            context = oVar.getContext();
            transactionId = getTransactionId();
            if (i == 0) {
