...
/* compiled from: RequestLocationUpdatesTaskApiCall */
public class o extends b<com.huawei.hms.support.api.a.o, Void> {
    ...
    static {
        C0201.m83(o.class, 18);
    }

    public o(String str, String str2, String str3, b bVar, Looper looper, String str4) {
        super(str, str2, str3, str4);
        this.b = bVar;
        if (looper == null) {
            this.c = new Handler() {
                /* class com.huawei.hms.support.api.a.b.o.AnonymousClass1 */
            ...
            this.c = new Handler(looper) {
                /* class com.huawei.hms.support.api.a.b.o.AnonymousClass2 */
    ...
    private void a(Message message) {
        String r2 = C0201.m82(5630);
        com.huawei.hms.support.api.a.c.b.b(r2, this.a, C0201.m82(5629) + message.what);
        try {
            int i2 = message.what;
            if (i2 == 1) {
            ...
            com.huawei.hms.support.api.a.c.b.d(r2, this.a, C0201.m82(5631));
        }
    }
    ...
    /* renamed from: a */
    public void doExecute(com.huawei.hms.support.api.a.o oVar, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource<Void> taskCompletionSource) {
        String str2;
        int i2;
        String str3;
        int i3;
            ...
            try {
                if (responseErrorCode.getErrorCode() == 0) {
                    ...
                    if (!(bVar == null || bVar.b() == null)) {
                        if (this.b.d() != null) {
                            if (jSONObject.has(l)) {
                                com.huawei.hms.support.api.a.c.b.b(str2, this.a, h);
                                LocationResult c2 = c.c(jSONObject);
                                int g2 = this.b.g();
                                int size = c2.getLocations().size();
                                String str5 = this.a;
                                com.huawei.hms.support.api.a.c.b.b(str2, str5, f + g2 + g + size);
                                if (g2 > 0) {
                                    if (g2 >= size) {
                                        if (g2 == size) {
                                ...
                                com.huawei.hms.support.api.a.c.b.b(str2, this.a, n);
                    ...
                    com.huawei.hms.support.api.a.c.b.d(str2, this.a, d);
                    return;
                }
                z = false;
                try {
                    ...
                    try {
                        com.huawei.hms.support.api.a.c.b.d(str2, this.a, k);
