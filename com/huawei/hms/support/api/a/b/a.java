...
/* compiled from: AddGeofencesTaskApiCall */
public class a extends b<q, Void> {
    ...
    public void doExecute(q qVar, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource<Void> taskCompletionSource) {
        ...
        try {
            ...
            i = e.getStatusCode();
            String str3 = this.a;
            b.d(r11, str3, C0201.m82(4620) + e.getMessage());
