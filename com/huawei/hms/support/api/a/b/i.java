...
/* compiled from: RemoveActivityUpdatesTaskApiCall */
public class i extends b<n, Void> {
    private c b;
    ...
    public void doExecute(n nVar, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource<Void> taskCompletionSource) {
        String r4 = C0201.m82(5022);
        try {
            b.b(r4, this.a, C0201.m82(5023));
