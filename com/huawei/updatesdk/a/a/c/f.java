...
public abstract class f {
    ...
    private static Class a(Field field, int i) {
        ...
        if ((genericType instanceof ParameterizedType) && (actualTypeArguments = ((ParameterizedType) genericType).getActualTypeArguments()) != null && actualTypeArguments.length > i) {
            try {
                ...
                int indexOf = obj.indexOf(C0201.m82(24666));
                if (indexOf < 0) {
                    indexOf = 0;
                }
                int indexOf2 = obj.indexOf(C0201.m82(24667));
                if (indexOf2 < 0) {
                    indexOf2 = obj.length();
                }
                ...
                String str = a;
                a.b(str, C0201.m82(24668) + e.getMessage());
            }
        }
        return null;
    }
    ...
    public static Field[] a(Class cls) {
        ...
        for (Field field : declaredFields) {
            if (field.getName().indexOf(C0201.m82(24669)) < 0) {
                arrayList.add(field);
            }
        }
