...
public interface a extends IInterface {
    ...
    void J3(PlaybackStateCompat playbackStateCompat) throws RemoteException;

    void K3(String str, Bundle bundle) throws RemoteException;

    void N1(boolean z) throws RemoteException;

    void T3(ParcelableVolumeInfo parcelableVolumeInfo) throws RemoteException;

    void Z1(MediaMetadataCompat mediaMetadataCompat) throws RemoteException;
