...
public class v2 {
    ...
    static {
        C0201.m83(v2.class, 248);
    }

    private static boolean a(ActionBar actionBar, KeyEvent keyEvent) {
        if (!a) {
            try {
                b = actionBar.getClass().getMethod(C0201.m82(8248), KeyEvent.class);
    ...
    public static boolean e(a aVar, View view, Window.Callback callback, KeyEvent keyEvent) {
        ...
        if ((view == null || !k3.g(view, keyEvent)) && !aVar.j(keyEvent)) {
            return false;
        }
        return true;
    }
    ...
    private static DialogInterface.OnKeyListener f(Dialog dialog) {
        if (!c) {
            try {
                Field declaredField = Dialog.class.getDeclaredField(C0201.m82(8249));
                d = declaredField;
