...
public final class ly0 extends ky0 {
    ...
    public final int b(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i7 < length) {
            ...
            if (charAt2 < 128 && i8 < i6) {
                ...
                sb.append(C0201.m82(16982));
                sb.append(charAt2);
                sb.append(C0201.m82(16983));
                sb.append(i8);
                throw new ArrayIndexOutOfBoundsException(sb.toString());
            } else {
                throw new my0(i7, length);
            }
            i8 = i4;
            i7++;
        }
