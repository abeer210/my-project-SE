...
public final class gm1 extends uj1<Long> implements rl1<Long>, en1, RandomAccess {
    private long[] b;
    private int c;
    ...
    private final String c(int i) {
        ...
        sb.append(C0201.m82(29448));
        sb.append(i);
        sb.append(C0201.m82(29449));
        sb.append(i2);
        return sb.toString();
    }
    ...
    public final /* synthetic */ rl1<Long> C0(int i) {
        if (i >= this.c) {
            return new gm1(Arrays.copyOf(this.b, i), this.c);
        }
    ...
    public final boolean addAll(Collection<? extends Long> collection) {
        a();
        nl1.a(collection);
        if (!(collection instanceof gm1)) {
            return super.addAll(collection);
        }
        gm1 gm1 = (gm1) collection;
        int i = gm1.c;
        if (i == 0) {
            return false;
        }
        ...
        if (C0188.f24 - i2 >= i) {
            ...
            System.arraycopy(gm1.b, 0, this.b, this.c, gm1.c);
            this.c = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final void removeRange(int i, int i2) {
        ...
        throw new IndexOutOfBoundsException(C0201.m82(29450));
    }
