...
public final class ip1 {
    ...
    private static void a(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        ...
        if (obj instanceof hp1) {
            ...
            for (Field field : fields) {
                ...
                if (!i.equals(name) && (modifiers & 1) == 1 && (modifiers & 8) != 8) {
                    String str2 = k;
        ...
        if (obj instanceof String) {
            ...
            if (!str5.startsWith(j) && str5.length() > 200) {
                str5 = String.valueOf(str5.substring(0, 200)).concat(c);
            }
            ...
            for (int i4 = 0; i4 < length2; i4++) {
                ...
                if (charAt < ' ' || charAt > '~' || charAt == '\"' || charAt == '\'') {
                    sb.append(String.format(p, Integer.valueOf(charAt)));
                } else {
                    sb.append(charAt);
                }
            }
            ...
            if (bArr == null) {
                ...
                for (byte b2 : bArr) {
                    ...
                    if (i5 == 92 || i5 == 34) {
                        ...
                        stringBuffer2.append(String.format(h, Integer.valueOf(i5)));
                    } else {
                        stringBuffer2.append((char) i5);
                    }
                }
    ...
    public static <T extends hp1> String b(T t) {
        String r0 = C0201.m82(17430);
        if (t == null) {
            return C0201.m82(17431);
        }
