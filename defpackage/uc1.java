...
public final class uc1 extends oc1 {
    private static int g(byte[] bArr, int i, long j, int i2) {
        if (i2 == 0) {
            return nc1.e(i);
        }
        if (i2 == 1) {
            return nc1.m(i, kc1.a(bArr, j));
        }
        if (i2 == 2) {
            return nc1.d(i, kc1.a(bArr, j), kc1.a(bArr, j + 1));
        }
    ...
    public final int a(int i, byte[] bArr, int i2, int i3) {
        ...
        throw new ArrayIndexOutOfBoundsException(String.format(C0201.m82(25056), Integer.valueOf(bArr.length), Integer.valueOf(i2), Integer.valueOf(i3)));
    }
    ...
    public final int b(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        String r9 = C0201.m82(25057);
        String r10 = C0201.m82(25058);
        ...
        while (true) {
            ...
            if (i4 < length && (charAt = charSequence.charAt(i4)) < 128) {
                ...
                while (i4 < length) {
                    ...
                    if (charAt3 < c && j3 < j4) {
                        long j6 = j3 + j5;
                        kc1.i(bArr, j3, (byte) charAt3);
                        j2 = j5;
                        j = j6;
                    } else if (charAt3 < 2048 && j3 <= j4 - 2) {
                        long j7 = j3 + j5;
                        kc1.i(bArr, j3, (byte) ((charAt3 >>> 6) | 960));
                        kc1.i(bArr, j7, (byte) ((charAt3 & '?') | 128));
                        j = j7 + j5;
                        j2 = j5;
                        i4++;
                        c = 128;
                        ...
                        long j8 = j3 + j5;
                        kc1.i(bArr, j3, (byte) ((charAt3 >>> '\f') | 480));
                        long j9 = j8 + j5;
                        kc1.i(bArr, j8, (byte) (((charAt3 >>> 6) & 63) | 128));
                        kc1.i(bArr, j9, (byte) ((charAt3 & '?') | 128));
                        j = j9 + 1;
                        j2 = 1;
                    } else if (j3 <= j4 - 4) {
                        int i5 = i4 + 1;
                        if (i5 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt3, charAt4)) {
                                ...
                                long j10 = j3 + 1;
                                kc1.i(bArr, j3, (byte) ((codePoint >>> 18) | 240));
                                long j11 = j10 + 1;
                                kc1.i(bArr, j10, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j12 = j11 + 1;
                                kc1.i(bArr, j11, (byte) (((codePoint >>> 6) & 63) | 128));
                                j2 = 1;
                                j = j12 + 1;
                                kc1.i(bArr, j12, (byte) ((codePoint & 63) | 128));
                                i4 = i5;
                                i4++;
                                c = 128;
                                j3 = j;
    ...
    public final void c(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        int length = charSequence.length();
        String r13 = C0201.m82(25059);
        String r14 = C0201.m82(25060);
        if (((long) length) <= limit - position) {
            int i2 = 0;
            while (true) {
                char c = 128;
                if (i2 < length && (charAt = charSequence.charAt(i2)) < 128) {
                    kc1.b(position, (byte) charAt);
                    i2++;
                    position = 1 + position;
                } else if (i2 != length) {
                    ...
                    while (i2 < length) {
                        ...
                        if (charAt2 < c && position < limit) {
                            ...
                            if ((charAt2 < 55296 || 57343 < charAt2) && position <= limit - 3) {
                                long j2 = position + 1;
                                kc1.b(position, (byte) ((charAt2 >>> '\f') | 480));
                                long j3 = j2 + 1;
                                kc1.b(j2, (byte) (((charAt2 >>> 6) & 63) | 128));
                                kc1.b(j3, (byte) ((charAt2 & '?') | 128));
                                position = j3 + 1;
                                ...
                                if (i3 != length) {
                                    ...
                                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                                        ...
                                        long j4 = position + 1;
                                        kc1.b(position, (byte) ((codePoint >>> 18) | 240));
                                        long j5 = j4 + 1;
                                        kc1.b(j4, (byte) (((codePoint >>> 12) & 63) | 128));
                                        long j6 = j5 + 1;
                                        kc1.b(j5, (byte) (((codePoint >>> 6) & 63) | 128));
                                        long j7 = j6 + 1;
                                        kc1.b(j6, (byte) ((codePoint & 63) | 128));
                                        i2 = i3;
                                        position = j7;
                                    } else {
                                        i2 = i3;
                                ...
                                throw new rc1(i2, length);
                            }
                        } else {
                            j = k;
                            long j8 = position + 1;
                            kc1.b(position, (byte) ((charAt2 >>> 6) | 960));
                            kc1.b(j8, (byte) ((charAt2 & '?') | 128));
                            position = j8 + 1;
                        }
                        i2++;
                        k = j;
    ...
    @Override // defpackage.oc1
    public final String f(byte[] bArr, int i, int i2) throws v91 {
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            int i3 = i + i2;
            char[] cArr = new char[i2];
            int i4 = 0;
            while (i < i3) {
                byte a = kc1.a(bArr, (long) i);
                if (!qc1.m(a)) {
                    break;
                }
                i++;
            ...
            while (i < i3) {
                int i6 = i + 1;
                byte a2 = kc1.a(bArr, (long) i);
                if (qc1.m(a2)) {
                    int i7 = i5 + 1;
                    qc1.h(a2, cArr, i5);
                    while (i6 < i3) {
                        byte a3 = kc1.a(bArr, (long) i6);
                        if (!qc1.m(a3)) {
                            break;
                        }
                        i6++;
                    ...
                    if (i6 < i3) {
                        int i8 = i6 + 1;
                        qc1.g(a2, kc1.a(bArr, (long) i6), cArr, i5);
                        i = i8;
                        i5++;
                    } else {
                        throw v91.j();
                    ...
                    if (i6 < i3 - 1) {
                        int i9 = i6 + 1;
                        int i10 = i9 + 1;
                        qc1.f(a2, kc1.a(bArr, (long) i6), kc1.a(bArr, (long) i9), cArr, i5);
                        i = i10;
                        i5++;
                    } else {
                        throw v91.j();
                    ...
                    int i11 = i6 + 1;
                    int i12 = i11 + 1;
                    qc1.e(a2, kc1.a(bArr, (long) i6), kc1.a(bArr, (long) i11), kc1.a(bArr, (long) i12), cArr, i5);
                    i = i12 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw v91.j();
        ...
        throw new ArrayIndexOutOfBoundsException(String.format(C0201.m82(25061), Integer.valueOf(bArr.length), Integer.valueOf(i), Integer.valueOf(i2)));
    }
}
