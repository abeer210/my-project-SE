...
public final /* synthetic */ class cv0 {
    ...
    static {
        ...
        b = iArr;
        try {
            iArr[py0.DOUBLE.ordinal()] = 1;
        } catch (NoSuchFieldError unused) {
        }
        try {
            b[py0.FLOAT.ordinal()] = 2;
        } catch (NoSuchFieldError unused2) {
        }
        try {
            b[py0.INT64.ordinal()] = 3;
        } catch (NoSuchFieldError unused3) {
        }
        try {
            b[py0.UINT64.ordinal()] = 4;
        } catch (NoSuchFieldError unused4) {
        }
        try {
            b[py0.INT32.ordinal()] = 5;
        } catch (NoSuchFieldError unused5) {
        }
        try {
            b[py0.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError unused6) {
        }
        try {
            b[py0.FIXED32.ordinal()] = 7;
        } catch (NoSuchFieldError unused7) {
        }
        try {
            b[py0.BOOL.ordinal()] = 8;
        } catch (NoSuchFieldError unused8) {
        }
        b[py0.GROUP.ordinal()] = 9;
        b[py0.MESSAGE.ordinal()] = 10;
        b[py0.STRING.ordinal()] = 11;
        b[py0.BYTES.ordinal()] = 12;
        b[py0.UINT32.ordinal()] = 13;
        b[py0.SFIXED32.ordinal()] = 14;
        b[py0.SFIXED64.ordinal()] = 15;
        b[py0.SINT32.ordinal()] = 16;
        b[py0.SINT64.ordinal()] = 17;
        try {
            b[py0.ENUM.ordinal()] = 18;
        } catch (NoSuchFieldError unused9) {
        }
        int[] iArr2 = new int[uy0.values().length];
        a = iArr2;
        iArr2[uy0.INT.ordinal()] = 1;
        a[uy0.LONG.ordinal()] = 2;
        a[uy0.FLOAT.ordinal()] = 3;
        a[uy0.DOUBLE.ordinal()] = 4;
        a[uy0.BOOLEAN.ordinal()] = 5;
        a[uy0.STRING.ordinal()] = 6;
        a[uy0.BYTE_STRING.ordinal()] = 7;
        a[uy0.ENUM.ordinal()] = 8;
        try {
            a[uy0.MESSAGE.ordinal()] = 9;
