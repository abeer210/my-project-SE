...
public final class qc1 {
    ...
    public static void a(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws v91 {
    ...
    /* access modifiers changed from: private */
    public static void b(byte b, byte b2, byte b3, char[] cArr, int i) throws v91 {
    ...
    /* access modifiers changed from: private */
    public static void c(byte b, byte b2, char[] cArr, int i) throws v91 {
        if (b < -62 || l(b2)) {
            throw v91.j();
        }
