...
public class o1 {
    ...
    public static Path e(String str) {
        ...
        try {
            ...
            throw new RuntimeException(C0201.m82(31728) + str, e);
        }
    }
    ...
    private static float[] h(String str) {
        ...
        try {
            ...
            throw new RuntimeException(C0201.m82(31729) + str + C0201.m82(31730), e);
        }
    }
    ...
    public static class b {
        ...
        private static void c(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            String r12 = C0201.m82(19367);
            if (d20 == 0.0d) {
                Log.w(r12, C0201.m82(19368));
                return;
            }
            double d21 = (1.0d / d20) - 0.25d;
            if (d21 < 0.0d) {
                Log.w(r12, C0201.m82(19369) + d20);
        ...
        public b(b bVar) {
            this.a = bVar.a;
            float[] fArr = bVar.b;
            this.b = o1.c(fArr, 0, fArr.length);
        }
    }
}
