...
public final class sc1 extends oc1 {
    ...
    public final int b(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i7 < length) {
            ...
            if (charAt2 < 128 && i8 < i6) {
                ...
                sb.append(C0201.m82(37876));
                sb.append(charAt2);
                sb.append(C0201.m82(37877));
                sb.append(i8);
                throw new ArrayIndexOutOfBoundsException(sb.toString());
            } else {
                throw new rc1(i7, length);
            }
            i8 = i4;
            i7++;
        }
    ...
    public final String f(byte[] bArr, int i, int i2) throws v91 {
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (i < i3) {
                ...
                if (qc1.m(b2)) {
                    ...
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        qc1.f(b2, bArr[i6], bArr[i8], cArr, i5);
                        i = i8 + 1;
                        i5++;
                    } else {
                        throw v91.j();
                    ...
                    byte b4 = bArr[i6];
                    int i10 = i9 + 1;
                    qc1.e(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                    i = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw v91.j();
        ...
        throw new ArrayIndexOutOfBoundsException(String.format(C0201.m82(37878), Integer.valueOf(bArr.length), Integer.valueOf(i), Integer.valueOf(i2)));
    }
}
